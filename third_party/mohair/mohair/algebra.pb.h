...
#ifndef GOOGLE_PROTOBUF_INCLUDED_mohair_2falgebra_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_mohair_2falgebra_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mohair_2falgebra_2eproto;
namespace mohair {
class ErrRel;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::mohair::ErrRel* Arena::CreateMaybeMessage<::mohair::ErrRel>(Arena*);
template<> ::mohair::ExecutionStats* Arena::CreateMaybeMessage<::mohair::ExecutionStats>(Arena*);
template<> ::mohair::PlanAnchor* Arena::CreateMaybeMessage<::mohair::PlanAnchor>(Arena*);
template<> ::mohair::QueryRel* Arena::CreateMaybeMessage<::mohair::QueryRel>(Arena*);
template<> ::mohair::SkyRel* Arena::CreateMaybeMessage<::mohair::SkyRel>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace mohair {

enum ErrRel_ErrType : int {
  ErrRel_ErrType_INVALID_MSG_TYPE = 0,
  ErrRel_ErrType_ErrRel_ErrType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  ErrRel_ErrType_ErrRel_ErrType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool ErrRel_ErrType_IsValid(int value);
constexpr ErrRel_ErrType ErrRel_ErrType_ErrType_MIN = ErrRel_ErrType_INVALID_MSG_TYPE;
constexpr ErrRel_ErrType ErrRel_ErrType_ErrType_MAX = ErrRel_ErrType_INVALID_MSG_TYPE;
constexpr int ErrRel_ErrType_ErrType_ARRAYSIZE = ErrRel_ErrType_ErrType_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ErrRel_ErrType_descriptor();
template<typename T>
inline const std::string& ErrRel_ErrType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, ErrRel_ErrType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function ErrRel_ErrType_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    ErrRel_ErrType_descriptor(), enum_t_value);
}
inline bool ErrRel_ErrType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, ErrRel_ErrType* value) {
...
class SkyRel final :
 ...
 public:
  ...
  private:
  bool _internal_has_execstats() const;
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    mutable std::atomic<int> _slices_cached_byte_size_;
...
class ErrRel final :
 ...
 public:
  ...
  typedef ErrRel_ErrType ErrType;
  static constexpr ErrType INVALID_MSG_TYPE =
    ErrRel_ErrType_INVALID_MSG_TYPE;
  static inline bool ErrType_IsValid(int value) {
    return ErrRel_ErrType_IsValid(value);
  }
  static constexpr ErrType ErrType_MIN =
    ErrRel_ErrType_ErrType_MIN;
  static constexpr ErrType ErrType_MAX =
    ErrRel_ErrType_ErrType_MAX;
  static constexpr int ErrType_ARRAYSIZE =
    ErrRel_ErrType_ErrType_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  ErrType_descriptor() {
    return ErrRel_ErrType_descriptor();
  }
  template<typename T>
  static inline const std::string& ErrType_Name(T enum_t_value) {
    static_assert(::std::is_same<T, ErrType>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function ErrType_Name.");
    return ErrRel_ErrType_Name(enum_t_value);
  }
  static inline bool ErrType_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      ErrType* value) {
...
class PlanAnchor final :
 ...
 public:
  ...
  private:
  bool _internal_has_anchor_rel() const;
  public:
...
void SkyRel::set_domain(ArgT0&& arg0, ArgT... args) {
...
inline void SkyRel::set_allocated_domain(std::string* domain) {
  if (domain != nullptr) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SkyRel::set_partition(ArgT0&& arg0, ArgT... args) {
...
inline void SkyRel::set_allocated_partition(std::string* partition) {
...
SkyRel::_internal_mutable_slices() {
  return &_impl_.slices_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >*
SkyRel::mutable_slices() {
  // @@protoc_insertion_point(field_mutable_list:mohair.SkyRel.slices)
  return _internal_mutable_slices();
}

// .mohair.ExecutionStats execstats = 4 [json_name = "execstats"];
inline bool SkyRel::_internal_has_execstats() const {
  return this != internal_default_instance() && _impl_.execstats_ != nullptr;
}
inline bool SkyRel::has_execstats() const {
  return _internal_has_execstats();
}
inline void SkyRel::clear_execstats() {
  if (GetArenaForAllocation() == nullptr && _impl_.execstats_ != nullptr) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ErrRel::set_err_msg(ArgT0&& arg0, ArgT... args) {
...
inline void ErrRel::set_allocated_err_msg(std::string* err_msg) {
  if (err_msg != nullptr) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void QueryRel::set_query(ArgT0&& arg0, ArgT... args) {
...
inline void QueryRel::set_allocated_query(std::string* query) {
  if (query != nullptr) {
...
// .substrait.Rel anchor_rel = 1 [json_name = "anchorRel"];
inline bool PlanAnchor::_internal_has_anchor_rel() const {
  return this != internal_default_instance() && _impl_.anchor_rel_ != nullptr;
}
inline bool PlanAnchor::has_anchor_rel() const {
  return _internal_has_anchor_rel();
}
...
template <> struct is_proto_enum< ::mohair::ErrRel_ErrType> : ::std::true_type {};
template <>
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_mohair_2falgebra_2eproto
