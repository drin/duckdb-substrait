...
struct ExecutionStatsDefaultTypeInternal {
  PROTOBUF_CONSTEXPR ExecutionStatsDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ExecutionStatsDefaultTypeInternal _ExecutionStats_default_instance_;
PROTOBUF_CONSTEXPR SkyRel::SkyRel(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.slices_)*/{}
  , /*decltype(_impl_._slices_cached_byte_size_)*/{0}
...
struct SkyRelDefaultTypeInternal {
  PROTOBUF_CONSTEXPR SkyRelDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SkyRelDefaultTypeInternal _SkyRel_default_instance_;
...
struct ErrRelDefaultTypeInternal {
  PROTOBUF_CONSTEXPR ErrRelDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ErrRelDefaultTypeInternal _ErrRel_default_instance_;
...
struct QueryRelDefaultTypeInternal {
  PROTOBUF_CONSTEXPR QueryRelDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 QueryRelDefaultTypeInternal _QueryRel_default_instance_;
PROTOBUF_CONSTEXPR PlanAnchor::PlanAnchor(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.anchor_rel_)*/nullptr
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct PlanAnchorDefaultTypeInternal {
  PROTOBUF_CONSTEXPR PlanAnchorDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PlanAnchorDefaultTypeInternal _PlanAnchor_default_instance_;
}  // namespace mohair
...
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_mohair_2falgebra_2eproto = nullptr;

const uint32_t TableStruct_mohair_2falgebra_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 8, -1, -1, sizeof(::mohair::SkyRel)},
  { 18, -1, -1, sizeof(::mohair::ErrRel)},
  { 26, -1, -1, sizeof(::mohair::QueryRel)},
  { 33, -1, -1, sizeof(::mohair::PlanAnchor)},
};
...
static ::_pbi::once_flag descriptor_table_mohair_2falgebra_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_mohair_2falgebra_2eproto = {
    false, false, 603, descriptor_table_protodef_mohair_2falgebra_2eproto,
    "mohair/algebra.proto",
    &descriptor_table_mohair_2falgebra_2eproto_once, descriptor_table_mohair_2falgebra_2eproto_deps, 2, 5,
    schemas, file_default_instances, TableStruct_mohair_2falgebra_2eproto::offsets,
    file_level_metadata_mohair_2falgebra_2eproto, file_level_enum_descriptors_mohair_2falgebra_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_mohair_2falgebra_2eproto(&descriptor_table_mohair_2falgebra_2eproto);
namespace mohair {
...
ExecutionStats::ExecutionStats(const ExecutionStats& from)
  ...
  ::memcpy(&_impl_.runtime_, &from._impl_.runtime_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.executed_) -
...
uint8_t* ExecutionStats::_InternalSerialize(
  ...
  if (this->_internal_executed() != 0) {
    ...
    target = ::_pbi::WireFormatLite::WriteBoolToArray(1, this->_internal_executed(), target);
  }
  ...
  if (raw_runtime != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(2, this->_internal_runtime(), target);
  }
...
SkyRel::SkyRel(const SkyRel& from)
  ...
  if (from._internal_has_execstats()) {
...
uint8_t* SkyRel::_InternalSerialize(
  ...
  // repeated uint32 slices = 3 [json_name = "slices"];
  {
    int byte_size = _impl_._slices_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
  ...
  // .mohair.ExecutionStats execstats = 4 [json_name = "execstats"];
  if (this->_internal_has_execstats()) {
...
// @@protoc_insertion_point(message_byte_size_start:mohair.SkyRel)
  ...
  // repeated uint32 slices = 3 [json_name = "slices"];
  {
    size_t data_size = ::_pbi::WireFormatLite::
      UInt32Size(this->_impl_.slices_);
    if (data_size > 0) {
      total_size += 1 +
        ::_pbi::WireFormatLite::Int32Size(static_cast<int32_t>(data_size));
    }
    int cached_size = ::_pbi::ToCachedSize(data_size);
    _impl_._slices_cached_byte_size_.store(cached_size,
...
uint8_t* ErrRel::_InternalSerialize(
  ...
  if (!this->_internal_err_msg().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "mohair.ErrRel.err_msg");
    target = stream->WriteStringMaybeAliased(
        1, this->_internal_err_msg(), target);
  }
...
inline void QueryRel::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
void PlanAnchor::clear_anchor_rel() {
  if (GetArenaForAllocation() == nullptr && _impl_.anchor_rel_ != nullptr) {
...
PlanAnchor::PlanAnchor(const PlanAnchor& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  if (from._internal_has_anchor_rel()) {
...
inline void PlanAnchor::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
uint8_t* PlanAnchor::_InternalSerialize(
  ...
  // .substrait.Rel anchor_rel = 1 [json_name = "anchorRel"];
  if (this->_internal_has_anchor_rel()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
