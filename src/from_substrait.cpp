  ...
  switch (setop) {
    ...
    default: {
      throw NotImplementedException(
        "SetOperationType transform not implemented for SetOp type %d", setop
      );
    }
  }
}
